...
it commit -m "fixed dependency on php-pdo"
...
```bash
gear-create-tag -f -n 8.2.28-alt2 -m "8.2.28-alt2
X-gear-specsubst: phpver=8.2" -u D63A85D9
```
...
```bash
pwd
/home/fad/hasher/repo/x86_64/RPMS.hasher

```


gear-hsh -t 8.2.28-alt2
cd /home/admin/hasher/repo/x86_64/RPMS.hasher
