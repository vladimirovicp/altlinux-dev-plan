...
BuildRequires(pre): rpm-build-php@phpver@-version rpm-build-licenses
...
* Mon Jul 28 2024 Petr Fadeev <fad@altlinux.org> 1:5.12.0-alt1
- Fix dependency on php-pdo (Closes: 53865).
