...
- https://bugzilla.altlinux.org/ - место куда надо сообщать о замеченных вами ошибках, также здесь можно оформить запрос на сборку нового пакета в Сизиф или бранч
...
- https://www.altlinux.org/ - Вики-документация сообщества
  ...
  - [Hasher/FAQ](https://www.altlinux.org/Hasher/FAQ)
- https://forum.altlinux.org/ - Форум сообщества
- https://packages.altlinux.org/ru/sisyphus/ - Список пакетов ALT Linux | это информационно-аналитический сайт для разработчиков и пользователей репозитория Sisyphus, а также бранчей (стабильных срезов репозитория Sisyphus, на основе которых и создаются все дистрибутивы ALT Linux).
...
## Обучение
  - https://uneex.ru/ - Различные лекции, ВМК МГУ и не только. Сайт тормозной.
